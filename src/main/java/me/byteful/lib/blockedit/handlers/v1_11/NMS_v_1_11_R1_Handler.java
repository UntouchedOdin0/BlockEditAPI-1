package me.byteful.lib.blockedit.handlers.v1_11;
...
public class NMS_v_1_11_R1_Handler implements Implementation {
  ...
  public void setBlock(
    ...
    if (option == BlockEditOption.NMS_SAFE) {
      ...
      chunk.a(bp, bd);
      if (applyPhysics) {
        world.update(bp, chunk.getBlockData(bp).getBlock(), true);
      }

      world.notify(bp, oldData, bd, applyPhysics ? 3 : 2);
    } else {
      throw new UnsupportedOperationException(
          "Specified option is not available for current implementation. (v1.11-R1)");
    }
  }
}
