package me.byteful.lib.blockedit.handlers.v1_9;
...
public class NMS_v_1_9_R1_Handler implements Implementation {
  ...
  public void setBlock(
    ...
    if (option == BlockEditOption.NMS_SAFE) {
      ...
      throw new UnsupportedOperationException(
          "Specified option is not available for current implementation. (v1.9-R1)");
    }
  }
