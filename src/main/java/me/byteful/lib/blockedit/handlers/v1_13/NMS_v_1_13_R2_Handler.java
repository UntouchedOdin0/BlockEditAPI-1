package me.byteful.lib.blockedit.handlers.v1_13;
...
public class NMS_v_1_13_R2_Handler implements Implementation {
  ...
  public void setBlock(
    ...
    if (option == BlockEditOption.NMS_SAFE) {
      ...
      throw new UnsupportedOperationException(
          "Specified option is not available for current implementation. (v1.13-R2)");
    }
  }
}
